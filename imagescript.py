...
pl.clf()
pl.axes([0.15,0.2,0.95-0.15,0.95-0.2])
pl.plot(x,y4,'-b',label='$n1_{analytical}$')
pl.plot(x,y3,'r2',label='$n1_{simulated}$',markersize=3)
pl.xlabel(r'$y$ [nm]')
pl.ylabel(r'$n$ [1/m$^2$]')
ax = pl.gca()
ax.yaxis.set_label_coords(xshift, 0.5)
...
pl.text(-0.19, 0.9, r'$\times 10^{-11}$', fontsize=8, transform = pl.gca().transAxes)
pl.legend()
